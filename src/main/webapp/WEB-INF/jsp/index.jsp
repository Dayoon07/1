...
<body>
    ...
    <c:if test="${ not empty AllChatRoom }">
	    <div class="mx-auto max-w-screen-xl w-full bg-white border-y-2">
	        <ul role="list" class="divide-y px-5">
	            <c:forEach var="room" items="${ AllChatRoom }">
	                <a href="${ cl }/chatroom/${ room.roomid }" class="flex justify-between gap-x-6 py-5 px-8 border-b-1 border-gray-300 hover:bg-gray-100">
